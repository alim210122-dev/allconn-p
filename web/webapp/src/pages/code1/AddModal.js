...
import {onInsert} from './api';


const insertHandle = (a,b) => {
    onInsert(a,b)
}
...
function AddModal2(props) {
    ...
    return (
        <Modal isOpen={modalState} toggle={toggle} backdrop={true}> 
            ...
            <ModalBody>
                {/* {JSON.stringify(errorMsg,errorMsg2)} */}
                <form className="pl-3 pr-3" action="#">
                    ...
                    <div className="form-group text-center">
                        {errorMsg.msg1 === '' && errorMsg2.msg2 === ''
                            ? <button className="btn btn-primary"  onClick ={() => insertHandle(inputs.addCode,inputs.addName)}>저장</button>
                            : null}
                    </div>
                </form>
            </ModalBody>
