...
import {Card, CardBody, Col, FormGroup, Input, InputGroup, Label, Row,} from 'reactstrap';
import './main.css';
  ...
  const onChange = e => {
    ...
    if (name === "businessNumber") {
      ...
      setInputs({
        ...
        businessNumber: newValue // name 키를 가진 값을 value 로 설정
      });
    } else {
      setInputs({
        ...inputs, // 기존의 input 객체를 복사한 뒤
          ...
          <Col lg={12}>
            <Card>
              <CardBody>
                ...
                <form onSubmit={() => insertEvent(inputs)}>
                  <FormGroup>
                    <Row form>
                      <Col md={2}>
                        ...
                        <Input type="select" name="companyCls" onChange={onChange} value={companyCls} ref={nameInput} required>
                          <option value=""></option>
                          <option value='A'>구매거래처</option>
                          <option value='B'>회계거래처</option>
                          <option value='C'>납품거래처</option>
                        </Input>
                      </Col>
                      <Col md={6}>
                    ...
                    <Row form>
                      <Col md={3}>
                        ...
                        <InputGroup>
                          <Input type="select" name="useYN" onChange={onChange} value={useYN}>
                            <option></option>
