...
// PPIS_PROJECT [공통관리]
const PartnerCompany = React.lazy(() => import('../pages/partnerCompany'));
const AddPartner     = React.lazy(() => import('../pages/partner'));
const MainCode1       = React.lazy(() => import('../pages/code1'));
const ProductMain       = React.lazy(() => import('../pages/code1/product/main'));
const ReduxFormat       = React.lazy(() => import('../pages/reduxFormat'));
const ProductCode       = React.lazy(() => import('../pages/code1/productForm'));
const ProductCodeDetail       = React.lazy(() => import('../pages/code1/productDetail'));
